...
describe "Formatting" do
  it "formats for seconds that are more than 1 hour" do
    seconds = 4500
    formatter = ApplicationHelper::Formatting.format_for(seconds)
  ...
  xit "formats the workout date time to a readable date" do
    run = FactoryGirl.create(:run, workout_datetime: "2012-11-03T23:12:49+00:00")
    formatter = ApplicationHelper::Formatting.format_for(run.workout_datetime)
