...
ActiveRecord::Schema.define(version: 20140225180930) do
  ...
  add_index "friendships", ["requester_id", "receiver_id"], name: "index_friendships_on_requester_id_and_receiver_id"
